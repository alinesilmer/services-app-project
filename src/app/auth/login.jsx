  ...
  useEffect(() => {
    const checkLoginStatus = async () => {
      ...
      if (loggedIn) {
        ...
        router.replace(type === 'professional' ? '/tabs/professional/home' : '/tabs/client/home');
      }
    };
    checkLoginStatus();
  }, []);
  ...
  const handleLogin = async () => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      ...
      if (loginResult.success && loginResult.user) {
        ...
        const type = loginResult.user.userType;
        router.replace(type === 'professional' ? '/tabs/professional/home' : '/tabs/client/home');
      } else {
  ...
  return (
    <>
      ...
      >
        ...
        <Text style={{ textAlign: 'center', marginTop: Metrics.marginS }}>
          {loginErrorMessage}
        </Text>
      </ModalCard>
    </>
